import{i,c}from"./index-CKFSp-7o.js";async function s(e,o){if(!i())return{decision:"UPDATED",previousState:e,newState:{...e,currentScore:o.score},reason:"Demo mode: accepting new evidence",confidence:.5};try{const t=c(),n=`You are deciding whether new evidence justifies updating an employee's capability state.
